...
import 'models/home_worker_model.dart';
...
class HomeWorkerPage extends StatelessWidget {
  HomeWorkerController controller =
      Get.put(HomeWorkerController(HomeWorkerModel().obs));
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomTextFormField(
                                ...
                                focusNode: FocusNode(),
                                controller: controller.markascompleteController,
                                hintText: "msg_mark_as_complete".tr,
                                margin: getMargin(
                                  bottom: 3,
                                ),
                                variant: TextFormFieldVariant.FillIndigo900,
                                shape: TextFormFieldShape.RoundedBorder5,
                                padding: TextFormFieldPadding.PaddingAll4,
                                fontStyle:
                                    TextFormFieldFontStyle.UrbanistRomanBold15,
                              ),
                              Padding(
                                padding: getPadding(
                                  top: 16,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        ...
                                        textAlign: TextAlign.left,
                                        style:
                                            AppStyle.txtUrbanistRomanRegular12,
                                      ),
                                    ),
                                    Padding(
                                      padding: getPadding(
